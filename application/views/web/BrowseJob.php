...
<!-- Mirrored from themes.2the.me/Boomerang/blog-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Mar 2018 06:00:40 GMT -->
<head>
        <meta charset="UTF-8">
                    ...
                    <div class="inner-nav">
                        <ul>
                            <li class="menu-item-has-children menu-item-has-mega-menu"><a href="#"><span class="menu-item-span">Home</span></a>
                                <div class="mega-menu">
                                    <ul class="sub-menu mega-menu-row" data-background="assets/images/menu-3.jpg" style="background-image: url(&quot;assets/images/menu-3.jpg&quot;);">
                                        <!-- Column 1-->
                            ...
                            <li class="menu-item-has-children menu-item-has-mega-menu"><a href="#"><span class="menu-item-span">Pages</span></a>
                                <div class="mega-menu">
                                    <ul class="sub-menu mega-menu-row" data-background="assets/images/menu-1.jpg" style="background-image: url(&quot;assets/images/menu-1.jpg&quot;);">
                                        <!-- Column 1-->
                            ...
                            <li class="menu-item-has-children menu-item-has-mega-menu"><a href="#"><span class="menu-item-span">Components</span></a>
                                <div class="mega-menu" style="margin-left: -206.719px;">
                                    <ul class="sub-menu mega-menu-row" data-background="assets/images/menu-2.jpg" style="background-image: url(&quot;assets/images/menu-2.jpg&quot;);">
                                        <!-- Column 1-->
                ...
                <div class="inner-navigation collapse">
                    <div class="inner-nav">
                        <ul>
                            <li class="menu-item-has-children menu-item-has-mega-menu"><a href="#"><span class="menu-item-span">Home</span></a>
                                <div class="mega-menu">
                                    <ul class="sub-menu mega-menu-row" data-background="<?php echo base_url(); ?>themes/boomerang/
/images/menu-3.jpg">
                                        <!-- Column 1-->
                                        <li class="menu-item-has-children mega-menu-col"><a href="#">Multi Page</a>
                                            <ul class="sub-menu">
