...
<div class="col-sm-4"><img class="img-fluid img-thumbnail" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/mega-menu/01.jpg" alt="Gallery-1">
</div>
<div class="col-sm-4"><img class="img-fluid img-thumbnail" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/mega-menu/02.jpg" alt="Gallery-2">
</div>
<div class="col-sm-4"><img class="img-fluid img-thumbnail" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/mega-menu/03.jpg" alt="Gallery-3">
</div>
</div>
<div class="row m-b-20">
<div class="col-sm-4"><img class="img-fluid img-thumbnail" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/mega-menu/04.jpg" alt="Gallery-4">
</div>
<div class="col-sm-4"><img class="img-fluid img-thumbnail" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/mega-menu/05.jpg" alt="Gallery-5">
</div>
<div class="col-sm-4"><img class="img-fluid img-thumbnail" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/mega-menu/06.jpg" alt="Gallery-6">
</div>
</div>
...
<li>
<div class="media">
<img class="d-flex align-self-center" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/user.png" alt="Generic placeholder image">
<div class="media-body">
...
<a href="#!">
 <img src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/user.png" alt="User-Profile-Image">
<span>John Doe</span>
<i class="ti-angle-down"></i>
</a>
...
<h2>Popular</h2>
<a class="dummy-media-object" href="#!">
<img src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-1.png" alt="PagePreloadingEffect" />
<h3>Page Preloading Effect</h3>
</a>
<a class="dummy-media-object" href="#!">
<img src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-1.png" alt="DraggableDualViewSlideshow" />
...
<h2>Recent</h2>
<a class="dummy-media-object" href="#!">
<img src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-1.png" alt="TooltipStylesInspiration" />
<h3>Tooltip Styles Inspiration</h3>
</a>
<a class="dummy-media-object" href="#!">
<img src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-1.png" alt="NotificationStyles" />
...
<img class="media-object img-circle" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-1.png" alt="Generic placeholder image">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/task/task-u1.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-2.png" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/task/task-u2.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/task/task-u3.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-3.png" alt="Generic placeholder image">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-4.png" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-circle" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-5.png" alt="Generic placeholder image">
<div class="live-status bg-danger"></div>
</a>
<div class="media-body">
...
<img class="media-object img-circle m-t-5" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-1.png" alt="Generic placeholder image">
</a>
...
<a href="#!">
<img class="media-object img-circle m-t-5" src=" <?php echo base_url()?>themes/ltr/vertical-static/assets/images/avatar-2.png" alt="Generic placeholder image">
</a>
</div>
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="email-2" class="block">Acronym</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="password-2" class="block">T.I.N Number </label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="password-2" name="password" type="text" class="form-control ">
</div>
</div>
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="confirm-2" class="block">Business Permit/Year issued</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="confirm-2" name="confirm" type="text" class="form-control ">
</div>
</div>
<div class="form-group row">
<div class="col-sm-2 col-lg-4">Establishment type</div>
<div class="col-sm-8 col-lg-10">
<select class="form-control required">
<option>Select Type</option>
<option>Government</option>
<option>Private/Direct Company</option>
</select>
</div>

</div>
<div class="form-group row">
<div class="col-sm-2 col-lg-4">Recruitment Agency</div>
<div class="col-sm-8 col-lg-10">
<select class="form-control required">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="name-2" class="block">Industry Type</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="surname-2" class="block">Complete Address</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="phone-2" class="block">Telephone #</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="phone-2" class="block">FAX #</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="phone-2" name="phone" type="number" class="form-control phone">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="date" class="block">E-mail Address</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="surname-2" class="block">Website(if any)</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="surname-2" name="surname" type="text" class="form-control">
</div>
...
<h3> General Information1 </h3>
<fieldset>
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="University-2" class="block">Name of Head/Owner</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Country-2" class="block">Position</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Degreelevel-2" class="block">Contact Person(For referral)</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="datejoin" class="block">Position</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="datejoin" class="block">Telephone/Cellphone #</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="datejoin" name="Date Of Birth" type="text" class="form-control required">
</div>
...
<h3> Name of Authorized Representative </h3>
<fieldset>
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Company-2" class="block">FullName</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="CountryW-2" class="block">Position</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Position-2" class="block">Fullname</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<h3> For Recruitment Agency </h3>
<fieldset>
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Company-2" class="block">Dole License/Registration:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="Company-2" name="Company:" type="text" class="form-control required">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="CountryW-2" class="block">Data Issued</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="CountryW-2" name="Country" type="text" class="form-control required">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Position-2" class="block">Valid Until</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="Position-2" name="Position" type="text" class="form-control required">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Position-2" class="block">Police License (for Overseas) Date Issued</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="Position-2" name="Position" type="text" class="form-control required">
</div>
...
<!-- <script src=" <?php echo base_url()?>themes/cdnjs.cloudflare.com/ajax/libs/underscore.js/1.8.3/underscore-min.js"></script> -->
<!-- <script src=" <?php echo base_url()?>themes/cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.6/moment.min.js"></script> -->
