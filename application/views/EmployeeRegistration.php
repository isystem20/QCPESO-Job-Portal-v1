...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="userName-2" class="block">Suffix(Sr, Jr):</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="userName-2" name="userName" type="text" class=" form-control">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="name-2" class="block">Birth Date:</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="phone-2" class="block">Age:</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="surname-2" class="block">Place of Birth:</label>
</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="phone-2" class="block">Phone Number:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="phone-2" name="phone" type="number" class="form-control phone">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">Sex:</div>
<div class="col-sm-8 col-lg-10">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">Civil Status:</div>
<div class="col-sm-8 col-lg-10">
<select class="form-control required">
...
<h3>Personal Information.3</h3>
<fieldset>
<div class="form-group row">
<div class="col-sm-2 col-lg-4">Employment Status:</div>
<div class="col-sm-8 col-lg-10">
<select class="form-control required">
<option>Select Status</option>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="userName-2" class="block">Preferred Occupation:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="userName-2" name="userName" type="text" class=" form-control">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">Preferred Work Location:</div>
<div class="col-sm-8 col-lg-10">
<select class="form-control required">
<option>Select Work Location</option>
<option>Local Employment</option>
<option>Overseas Employment</option>
<option>Both Local and Overseas</option>
</select>
</div>
</div>
<div class="form-group row">
<div class="col-sm-2 col-lg-4">Languages Spoken, Read an Written at Work:</div>
<div class="col-sm-8 col-lg-10">
<select class="form-control required">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">Disability:</div>
<div class="col-sm-8 col-lg-10">
<select class="form-control required">
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="userName-2" class="block">Others:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="userName-2" name="userName" type="text" class=" form-control">
</div>
...
<h3> For Kasambahay Program</h3>
<fieldset>
<div class="form-group row">
<div class="col-sm-2 col-lg-4">Select your Job Description:</div>
<div class="col-sm-8 col-lg-10">
<select class="form-control required">
<option>Select Job</option>
<option>Maid/Houseboy</option>
<option>Cook</option>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="CountryW-2" class="block">Others:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="CountryW-2" name="Country" type="text" class="form-control required">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Position-2" class="block">Name of Employer:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="Position-2" name="Position" type="text" class="form-control required">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Position-2" class="block">Work Business of Employer:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="Position-2" name="Position" type="text" class="form-control required">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Position-2" class="block">Address of Employer:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="Position-2" name="Position" type="text" class="form-control required">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Position-2" class="block">Salary:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="Position-2" name="Position" type="text" class="form-control required">
</div>
...
<h3> For Kasambahay Program.2</h3>
<fieldset>
<div class="form-group row">
<div class="col-sm-2 col-lg-4">Status:</div>
<div class="col-sm-8 col-lg-10">
<select class="form-control required">
<option>Select Status</option>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="CountryW-2" class="block">Years of Service:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="CountryW-2" name="Country" type="text" class="form-control required">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Position-2" class="block">Previous Employer:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="Position-2" name="Position" type="text" class="form-control required">
</div>
...
<div class="form-group row">
<div class="col-sm-2 col-lg-4">
<label for="Position-2" class="block">Address:</label>
</div>
<div class="col-sm-8 col-lg-10">
<input id="Position-2" name="Position" type="text" class="form-control required">
</div>
