...
<!--                 <li class="nav-item">
                ...
                <li class="nav-item single-item">
                    <a href="form-picker.html">
                        ...
                        <span data-i18n="nav.form-pickers.main"> Add Applicant </span>
                        <label class="label label-warning menu-caption">NEW</label>
                    </a>
                </li>
                <li class="nav-item single-item">
                    <a href="form-picker.html">
                        <i class="ti-pencil-alt"></i>
                        <span data-i18n="nav.form-pickers.main"> Add Establishment </span>
                        <label class="label label-warning menu-caption">NEW</label>
                    </a>
                </li>  
                <li class="nav-item single-item">
                    <a href="form-picker.html">
                        <i class="ti-pencil-alt"></i>
                        <span data-i18n="nav.form-pickers.main"> Pending Accredication </span>
                        <label class="label label-warning menu-caption">NEW</label>
                    </a>
                </li>  
